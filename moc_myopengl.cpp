...
QT_MOC_LITERAL(1, 9, 10), // "IMUDatRecv"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "myopenGL\0IMUDatRecv\0"
};
...
void myopenGL::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->IMUDatRecv((*reinterpret_cast< float(*)>(_a[1])),(*reinterpret_cast< float(*)>(_a[2])),(*reinterpret_cast< float(*)>(_a[3]))); break;
        default: ;
        }
    }
}
